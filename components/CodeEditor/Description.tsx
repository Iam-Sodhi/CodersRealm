...
import { DBProblem, Problem } from "../../lib/Problems/types/Problem";
import {
  arrayRemove,
  arrayUnion,
  doc,
            ...
            <div className="mt-4">
              {problem.examples.map((example, index) => (
                <div key={example.id}>
                  ...
                  {example.img && (
					<Image src={example.img} alt="Problem photo" height={100} width={100} quality={90} className="h-full w-full" />
                  )}
